...
def expand_marker_detection(markers: pd.DataFrame, fill_value):
...
def get_interval_from_markers(starts: dict[int,list[int]], ends: dict[int,list[int]], pattern: list[int], max_intermarker_gap_duration: int, side='start') -> np.ndarray:
