...
def detect_blob_HSV(proc_name: str, frame_idx: int, frame: np.ndarray, frame_info: dict[str, typing.Any], cam_params: ocv.CameraParams, low: tuple[int], high: tuple[int], edge_cut_fac=9.):
    # for instance:
    # low = (40, 60, 40)
    # high= (70, 255, 255)
