...
Here we first present example workflows using the GUI. More detailed information about [gazeMapper configuration](#configuration) and [the programming API](#api) are provided below.
